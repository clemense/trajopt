...
env.Load("../data/wam_ifco.env.xml")
...
open_hand =   [2.22044605e-16,   1.84599970e-07, 1.09999484e-07,   1.99840144e-15]
closed_hand = [2.05682375,  2.11838913,  2.01956414,  0.]

arm_inds = manip.GetArmIndices().tolist() + manip.GetGripperIndices().tolist()
...
robot.SetDOFValues(joint_start, arm_inds)
...
joint_target = [7.98918993e-01, 6.79413453e-01, -1.22660855e+00, 2.18709939e+00, -2.01618750e-01, -7.73345768e-01, 9.24826794e-01] + closed_hand

request = {
  "basic_info" : {
    "n_steps" : n_steps,
#    "manip" : "arm", # see below for valid values
    "manip" : "arm+JF1+JF2+JF3+JF4",
...
#  }
  ...
  {
    "type" : "joint", # joint-space target
    "params" : {"vals" : [1.05371929e+00, 1.26100053e+00, -1.22660851e+00, 2.46288225e+00, 5.95319766e-02, -5.25648950e-01, 1.32330632e+00] + open_hand, "timestep" : 0.4 * n_steps } # length of vals = # dofs of manip
  },
  {
    "type" : "joint", # joint-space target
    "params" : {"vals" : [5.96063962e-01, 1.26100052e+00, -1.22660852e+00, 1.98155300e+00, -2.01618731e-01, -3.87601018e-01, 1.32330635e+00] + open_hand, "timestep" : 0.7 * n_steps } # length of vals = # dofs of manip
  }
  ],
  "init_info" : {
